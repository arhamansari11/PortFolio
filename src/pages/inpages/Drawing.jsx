...
const images = [
  { src: Image11, description: "Side Pose Live Portrait" },
  { src: Image5, description: "Front Live Portrait" },
  { src: Image10, description: "Pencil Portrait" },
  { src: Image9, description: "Copy Work" },
  { src: Image6, description: "Left Side Live Portrait" },
  { src: Image8, description: "3 / 4 Portrait" },
  { src: Image29, description: "Pencil Portrait" },
  { src: Image7, description: "Profile Portrait Right Side" },
  { src: Image4, description: "Hand Practice" },
  { src: Image15, description: "Tree Pencil Drawing" },
  ...
  { src: Image19, description: "Still Live Drawing (ContePencil)" },
  { src: Image16, description: "Still Live Drawing (Pencil)" },
  ...
  { src: Image26, description: "Still Live Drawing (Collage)" },
  { src: Image30, description: "Copy Work (CharCoal)" },
  { src: Image1, description: "Skull Study" },
];
